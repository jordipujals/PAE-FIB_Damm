import {
  ...
  utcTime,
  wiggle_default
} from "./chunk-I3HHKR3T.js";
import {
  NoSsr,
  Popper
} from "./chunk-CQV6NPWD.js";
import {
  useSlotProps
} from "./chunk-5ZV7XMFJ.js";
import {
  Typography_default
} from "./chunk-CHJOPFI4.js";
import "./chunk-DSISJ3UJ.js";
import {
  useTheme
} from "./chunk-BKNUHJ5L.js";
import {
  require_react_dom
} from "./chunk-OZ6A2BMG.js";
import {
  shouldForwardProp
} from "./chunk-NHNX6MHJ.js";
import "./chunk-QHCD26YE.js";
import {
  init_ownerWindow,
  init_useControlled,
  ...
  useForkRef,
  useId
} from "./chunk-UQPY3C3K.js";
import {
  styled_default,
  useThemeProps
} from "./chunk-OCSGVLWQ.js";
import {
  composeClasses,
...
function SeriesContextProvider(props) {
  ...
  const formattedSeries = React2.useMemo(() => formatSeries(series, typeof colors3 === "function" ? colors3(theme.palette.mode) : colors3, dataset), [series, colors3, theme.palette.mode, dataset]);
...
function usePieSeries() {
  ...
  return React3.useMemo(() => series.pie, [series.pie]);
}
function useLineSeries() {
  const series = useSeries();
  return React3.useMemo(() => series.line, [series.line]);
}
function useBarSeries() {
  const series = useSeries();
  return React3.useMemo(() => series.bar, [series.bar]);
}
function useScatterSeries() {
  const series = useSeries();
  return React3.useMemo(() => series.scatter, [series.scatter]);
}
...
function useHighlighted() {
  const highlighted = React5.useContext(HighlightedContext);
...
function useItemHighlighted(item) {
  const highlighted = React6.useContext(HighlightedContext);
  if (highlighted === void 0) {
    throw new Error(["MUI X: Could not find the highlighted ref context.", "It looks like you rendered your component outside of a ChartsContainer parent component."].join("\n"));
  }
  if (!item) {
...
var useChartDimensions = (width, height, margin) => {
  ...
  const drawingArea = React8.useMemo(() => ({
...
var DrawingContext = React9.createContext({
  top: 0,
  left: 0,
  bottom: 0,
  right: 0,
...
var SvgContext = React9.createContext({
  current: null
});
if (true) {
...
function DrawingProvider(props) {
  ...
  const chartId = useId();
  const value = React9.useMemo(() => _extends({
    chartId: chartId ?? ""
...
var CartesianContext = React13.createContext({
  xAxis: {},
  yAxis: {},
  xAxisIds: [],
  yAxisIds: []
...
function CartesianContextProvider(props) {
  ...
  const formattedSeries = React13.useContext(SeriesContext);
  const drawingArea = useDrawingArea();
  const xAxis = React13.useMemo(() => inXAxis == null ? void 0 : inXAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
  ...
  const yAxis = React13.useMemo(() => inYAxis == null ? void 0 : inYAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React22.useContext(CartesianContext), _ref = props.axisId ?? xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React23.useContext(CartesianContext), _ref = props.axisId ?? yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
...
function useMouseTracker() {
  const svgRef = React27.useContext(SvgContext);
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React29.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
  const {
    xAxis,
    yAxis,
    xAxisIds,
...
function ChartsAxisTooltipContent(props) {
  ...
  const series = React31.useContext(SeriesContext);
...
function DefaultChartsLegend(props) {
  ...
  const labelStyle = React33.useMemo(
  ...
  const padding = React33.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React33.useCallback((label, inStyle = {}) => {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React33.useMemo(() => {
    let x = 0;
    let y = 0;
  ...
  _clipSegment(x0, y0, x1, y1, c0, c12) {
    ...
    while (true) {
      ...
      if (c0)
        ...
        x1 = x, y1 = y, c12 = this._regioncode(x1, y1);
    }
  }
...
function ChartsVoronoiHandler(props) {
  ...
  const {
    series,
    seriesOrder
  } = React36.useContext(SeriesContext).scatter ?? {};
...
function ChartsOnAxisClickHandler(props) {
  ...
  const svgRef = React37.useContext(SvgContext);
  const series = React37.useContext(SeriesContext);
  const {
    axis
...
var useInteractionItemProps = (skip) => {
  ...
  const {
    setHighlighted,
    clearHighlighted
  } = React40.useContext(HighlightedContext);
  if (skip) {
    return () => ({});
  }
...
var _excluded7 = ["id", "dataIndex", "classes", "color", "slots", "slotProps", "style", "onClick"];
...
true ? BarLabelPlot.propTypes = {
  ...
  bars: import_prop_types23.default.arrayOf(import_prop_types23.default.shape({
    ...
    maskId: import_prop_types23.default.string.isRequired,
    ...
    x: import_prop_types23.default.number.isRequired,
    xOrigin: import_prop_types23.default.number.isRequired,
    y: import_prop_types23.default.number.isRequired,
    yOrigin: import_prop_types23.default.number.isRequired
  })).isRequired,
...
var useAggregatedData = () => {
  const seriesData = React46.useContext(SeriesContext).bar ?? {
    series: {},
    stackingGroups: [],
    seriesOrder: []
  };
...
function useChartGradient() {
  ...
  return React51.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var ChartContainer = React52.forwardRef(function ChartContainer2(props, ref) {
  ...
  const svgRef = React52.useRef(null);
    ...
    children: (0, import_jsx_runtime36.jsx)(SeriesContextProvider, {
      ...
      children: (0, import_jsx_runtime36.jsx)(CartesianContextProvider, {
        ...
        children: (0, import_jsx_runtime36.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime36.jsx)(HighlightedProvider, {
            highlightedItem,
            onHighlightChange,
...
var BarChart = React58.forwardRef(function BarChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
...
var useAnimatedPath = (path, skipAnimation2) => {
  const previousPath = usePrevious(path);
  const interpolator = React59.useMemo(() => previousPath ? string_default(previousPath, path) : () => path, [previousPath, path]);
  const {
    value
  } = useSpring({
    from: {
...
function AnimatedArea(props) {
  ...
  const chartId = useChartId();
  const path = useAnimatedPath(d, skipAnimation2);
  const {
    animatedWidth
  } = useSpring({
    from: {
  ...
  return (0, import_jsx_runtime42.jsxs)(React60.Fragment, {
...
var _excluded18 = ["id", "classes", "color", "gradientId", "slots", "slotProps", "onClick"];
...
var _excluded25 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
var useAggregatedData3 = () => {
  const seriesData = React65.useContext(SeriesContext).line;
  const axisData = React65.useContext(CartesianContext);
  if (seriesData === void 0) {
    return [];
  }
  const {
...
var _excluded26 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "onClick", "skipAnimation"];
...
var _excluded27 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
function MarkPlot(props) {
  ...
  const seriesData = React67.useContext(SeriesContext).line;
  const axisData = React67.useContext(CartesianContext);
  const chartId = useChartId();
...
var _excluded28 = ["x", "y", "id", "classes", "color"];
...
function LineHighlightPlot(props) {
  ...
  const seriesData = React69.useContext(SeriesContext).line;
  const axisData = React69.useContext(CartesianContext);
  const {
    axis
...
var LineChart = React70.forwardRef(function LineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
...
var _excluded30 = ["classes", "color", "cornerRadius", "dataIndex", "endAngle", "id", "innerRadius", "isFaded", "isHighlighted", "onClick", "outerRadius", "paddingAngle", "startAngle", "highlightScope"];
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React72.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
var _excluded31 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlighted", "faded", "data", "onItemClick", "skipAnimation"];
...
var _excluded32 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "arcLabelRadius", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "style"];
...
var _excluded33 = ["arcLabel", "arcLabelMinAngle", "arcLabelRadius", "cornerRadius", "data", "faded", "highlighted", "id", "innerRadius", "outerRadius", "paddingAngle", "skipAnimation", "slotProps", "slots"];
...
function PiePlot(props) {
  ...
  const seriesData = React76.useContext(SeriesContext).pie;
  const {
    left,
    top,
    width,
    height
  } = React76.useContext(DrawingContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
...
true ? PieChart.propTypes = {
  ...
  xAxis: import_prop_types45.default.arrayOf(import_prop_types45.default.shape({
    ...
    max: import_prop_types45.default.oneOfType([import_prop_types45.default.instanceOf(Date), import_prop_types45.default.number]),
    min: import_prop_types45.default.oneOfType([import_prop_types45.default.instanceOf(Date), import_prop_types45.default.number]),
    position: import_prop_types45.default.oneOf(["bottom", "left", "right", "top"]),
...
function Scatter(props) {
  ...
  const cleanData = React78.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
...
function ScatterPlot(props) {
  ...
  const seriesData = React79.useContext(SeriesContext).scatter;
  const axisData = React79.useContext(CartesianContext);
  const {
    zAxis,
    zAxisIds
  ...
  return (0, import_jsx_runtime60.jsx)(React79.Fragment, {
    children: seriesOrder.map((seriesId) => {
      const {
        id,
        xAxisKey,
...
var ScatterChart = React80.forwardRef(function ScatterChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    zAxis,
...
var SparkLineChart = React81.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    width,
    height,
  ...
  return (0, import_jsx_runtime62.jsxs)(ResponsiveChartContainer, {
    ...
    }), plotType === "line" && (0, import_jsx_runtime62.jsxs)(React81.Fragment, {
...
true ? SparkLineChart.propTypes = {
  ...
  xAxis: import_prop_types49.default.shape({
    axisId: import_prop_types49.default.oneOfType([import_prop_types49.default.number, import_prop_types49.default.string]),
    classes: import_prop_types49.default.object,
    ...
    max: import_prop_types49.default.oneOfType([import_prop_types49.default.instanceOf(Date), import_prop_types49.default.number]),
    min: import_prop_types49.default.oneOfType([import_prop_types49.default.instanceOf(Date), import_prop_types49.default.number]),
    position: import_prop_types49.default.oneOf(["bottom", "left", "right", "top"]),
...
var GaugeContext = React82.createContext({
  value: null,
  valueMin: 0,
  valueMax: 0,
  startAngle: 0,
...
function useGaugeState() {
  return React82.useContext(GaugeContext);
}

// node_modules/@mui/x-charts/esm/Gauge/GaugeContainer.js
var import_jsx_runtime64 = __toESM(require_jsx_runtime());
var _excluded34 = ["width", "height", "margin", "title", "desc", "value", "valueMin", "valueMax", "startAngle", "endAngle", "outerRadius", "innerRadius", "cornerRadius", "cx", "cy", "children"];
...
var GaugeContainer = React83.forwardRef(function GaugeContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight,
    margin,
...
var _excluded35 = ["text", "className"];
...
var _excluded36 = ["text", "children", "classes"];
